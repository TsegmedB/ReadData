function XYZ = IAGA_2002(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   XYZ = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   XYZ = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   XYZ = importfile('2010-2019_XYZ.dat', 1, 71856);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2023/02/17 11:38:50
...
formatSpec = '%10s%13s%4s%13s%10s%10s%7s%s%[^\n\r]';
...
XYZ = table;
XYZ.DATE = dates{:, 1};
XYZ.TIME = categorical(rawStringColumns(:, 1));
XYZ.DOY = cell2mat(rawNumericColumns(:, 1));
XYZ.IRTX = cell2mat(rawNumericColumns(:, 2));
XYZ.IRTY = cell2mat(rawNumericColumns(:, 3));
XYZ.IRTZ = cell2mat(rawNumericColumns(:, 4));
XYZ.IRTF = cell2mat(rawNumericColumns(:, 5));
XYZ.VarName8 = cell2mat(rawNumericColumns(:, 6));
